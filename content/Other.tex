...
Add a ruler for character limit: Ctrl + Shift + P, write ``setting json'', add to the final line \text{"editor.rulers": [ 80 ]}
...
\begin{itemize}
    ...
    \item \quickimage{debugCommands.png}{.5}
\end{itemize}
...
If the image is in a ITU recommendation or something like that and a .docx or pdf is available, either:
\begin{itemize}
